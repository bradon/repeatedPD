...
The simulation uses a Wright-Fisher process \citep{hartl1997principles}. Figure \ref{fig:wright} gives an overview of this process. 
...
The intensity of selection was set at 1.0 for simulations. 

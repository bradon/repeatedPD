...
Results are compared to a previous simulation that used an FSA representation (Section \ref{sec:overall}). 
\item Do theoretical results hold with the larger strategy space? In certain regions of the graph, a bound can be placed on the behaviour seen (Section \ref{sec:pnas}). 
...
\item Conclusion, where I will summarise my work, and discuss future work.
\end{itemize}
...
These diagrams visualize the dynamics seen-- what strategies will be selected for in a given population \citep{imhof:PNAS:2005}. 
For example, a small number of ALLD can quickly dominate a population of ALLC since ALLD gains a better payoff. The arrows give the rate of change of proportion of the population and direction in which it moves from that situation.  ALLC moves towards ALLD. 
...
These mechanisms can be simulated with differing lengths of games, and differing likelihood of meeting  a strategy meeting an alike strategy. 
Other mechanisms, such as strategies having access to reputation (an opponents past with other strategies)
...
Region I shows no cooperation, Region II shows a mixture of low cooperation, Region III shows a mixture of mostly cooperation, and Region IV is fully cooperative. 

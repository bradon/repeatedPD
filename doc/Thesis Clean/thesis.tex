...
Strategies not representable by past methods using Finite State Automata are found to evolve in the simulations. 

The success of these strategies is investigated. In deterministic games, they are not found to be advantageous. In games with noise, these strategies appear to have an advantage over strategies representable by Finite State Automata. 
...
\item intensityOfSelection specifies how strong the selection is \citep{nowak2006evolutionary63}.
